...
<main class="about">
  <section class="mobile__banner">
    <img src="/assets/images/about__banner.webp" alt="mobile__banner-img" class="mobile__banner-img" />
    <div class="mobile__banner-box">
      <img src="/assets/images/banner-box-img.png" alt="banner-box-img" class="banner__box-img" />
  ...
  <section class="banner">
    <div class="banner__bg-box">
      ...
      <div class="banner__box">
        ...
        <p class="banner__subtitle" class="banner__box-text" data-aos="fade-up" data-aos-delay="800" data-aos-duration="500">
          Я расскажу тебе о мире Destorus
        </p>
  ...
  <section class="accordion">
    <h2 class="world__title" data-aos="fade-up" data-aos-delay="100" data-aos-duration="500" data-aos-offset="-1100">
  ...
  <section class="connect">
    ...
    <div class="container">
      <div class="connect__box">
        <img src="/assets/images/banner-box-img.png" alt="connect__box-img" class="connect__box-img" />
